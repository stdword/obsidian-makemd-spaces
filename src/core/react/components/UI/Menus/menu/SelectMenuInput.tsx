...
const STYLE_PROPS = ["fontSize", "fontFamily", "fontWeight", "fontStyle", "letterSpacing", "textTransform"];
        ...
        return (
            <div className={classNames.search}>
                <div className={classNames.searchWrapper}>
                    ...
                    ></div>
                    <input {...inputAttributes} {...inputEventHandlers} ref={input} value={props.query} placeholder={placeholderText} className={classNames.searchInput} role="combobox" style={{ width: "100%" }} onClick={(e) => e.stopPropagation()} />
