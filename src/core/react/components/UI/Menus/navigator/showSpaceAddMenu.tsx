...
export const newNoteMenuOption = (superstate: Superstate, space: SpaceState, dontOpen?: boolean): SelectOption => ({
...
export const newFolderMenuOption = (superstate: Superstate, space: SpaceState): SelectOption => ({
