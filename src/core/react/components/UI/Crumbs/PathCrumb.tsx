...
//     const path = useMemo(() => (props.source && props.path ? spaceManager.resolvePath(props.path, props.source) : props.path), [props.source, props.path, spaceManager]);
...
//             }}
//         >
//             {cache && !props.hideIcon && <PathStickerView superstate={props.superstate} pathState={cache} />}
